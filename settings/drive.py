...
DRIVE_FOLDER = {
    ...
    'drawful2': '1T5SRc_cpajzrG9eq1FOQ0S3TQYD9UB-r',
...
MEDIA_FOLDER = {
    ...
    'drawful2': r'C:\Program Files (x86)\Steam\steamapps\common\Drawful 2\TalkshowExport\project\media',
...
SUBTITLES = {
    ...
    'drawful2': '../data/standalone/drawful2/encoded/audio_subtitles.json',
